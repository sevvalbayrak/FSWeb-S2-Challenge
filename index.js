...
//cumleKur(birinci = "Hello World!"){
let birinci = "";
let ikinci = "";
let ucuncu = "";
let dorduncu = "";
let besinci = "";
console.log(cumleKur(birinci = "Hello World!"))

/* (Oto test yok) cumleKur fonksiyonuna yalnızca 2 parametre göndererek "Hello World!" stringini elde edin, 
sonucu konsolde gözlemleyin */
console.log(cumleKur(birinci = "Hello ", ikinci="World!"))
...
console.log(emojileriDonustur("bugün çok iyi hissediyorum :D", emojiler))
